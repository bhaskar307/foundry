                            ...
                            <tr>
                                ...
                                <td style="max-width: 120px;">
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <button class="btnico" onclick="deleteVendor('<?= $row['uid'] ?>')">
    ...
    <div class="modal fade" id="editVendorModal" tabindex="-1" aria-labelledby="editVendorModalLabel"
        ...
        <div class="modal-dialog">
            <form id="editVendorModalForm" enctype="multipart/form-data">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editVendorModalLabel">Update Vendor Details</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3" id="oldImagePreview" style="display: none;">
                            ...
                            <img id="vendorOldImage" src="" alt="Vendor Image" width="100" class="img-thumbnail">
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
