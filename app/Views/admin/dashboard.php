<main class="content-body p-3">
    <div class="row g-3">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex flex-column gap-1">
                            ...
                            <div class="h2 mb-0 text-secondary"><?= $matrics['total_request'] ?? 00; ?></div>
                            <!-- <div class="small text-dark">+8.1% WoW</div> -->
                        </div>
                        <div>
                            <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 60" width="60" height="60">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex flex-column gap-1">
                            ...
                            <div class="h2 mb-0 text-warning"> <?= $matrics['total_customers'] ?? 00; ?> </div>
                            <!-- <div class="small text-dark">7-day total</div> -->
                        </div>
                        <div>
                            <svg fill="currentColor" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="60" height="60">
                                <g>
        ...
        <div class="col-12 col-xl-8">
            <div class="card h-100">
                <div class="card-header bg-white d-flex justify-content-between align-items-center">
                    <span class="h5 m-0">Request's</span>
        ...
        <div class="col-12 col-xl-4">
            <div class="card h-100">
                <div class="card-header bg-white h5">Top Review Product's</div>
        ...
        <div class="col-12 col-xxl-8">
            <div class="card h-100">
                <div class="card-header bg-white h5">Recent Request</div>
                <div class="card-body">
