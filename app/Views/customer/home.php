            ...
            <div class="mx-auto col-md-8 p-0">
                ...
                <div class="px-lg-5 mb-3 col-lg-10 mx-auto p-0 fadeUp">
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="Search for machines, tools, brands, and more...">
            ...
            <div class="swiper topCatSlider">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <a href="" class="position-relative rounded-10 overflow-hidden d-block topCatThmb">
        ...
        <div class="row g-lg-4 g-3">
            ...
            <div class="col-6 col-lg-3 fadeUp">
                <a href="#" class="h-100 rounded-10 border bg-white overflow-hidden d-block">
                    <img src="<?= base_url($row['image']) ?>" alt="" class="w-100 object-fit-cover" style="height:300px;">
    ...
    <div class="container">
        <div class="rounded-15 py-5 px-4 px-lg-5 bannerCta position-relative overflow-hidden text-center text-white">
            ...
            <div class="py-lg-5 px-0 mx-auto col-md-8 col-lg-6 fadeUp">
                ...
                <a href="" class="btn btn-white px-4">Shop Now</a>
            </div>
        </div>
    </div>
</section>
