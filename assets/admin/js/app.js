...
(function (window, Calendar) {
  ...
  function saveNewSchedule(scheduleData) {
    ...
    console.log("===========>", localStorage.getItem("clinicUid"));
    console.log("=>>>>>>>>>>>>>>>>>>>>>> saveNewSchedule", scheduleData);
  }
//   fetch("https://yourdomain.com/api/save-event", {
//     method: "POST",
//     headers: {
...
//       // Only create in calendar UI if save is successful
//       cal.createSchedules([schedule]);
//       refreshScheduleVisibility();
//     })
//     .catch((error) => {
